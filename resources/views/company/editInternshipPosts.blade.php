            ...
            <div class="card-body">
                    ...
                    @if (session('status'))
                        <div class="alert alert-success" role="alert">
                            {{ session('status') }}<a href="{{ route('company.workingInternship', ['id' => $post->placement_drive_id ]) }}">{{__('Go to  Working Internships ')}}</a>
                        </div>
                    @endif
                   
                    <form method="POST"  id="frm"  name="frm"  action="{{ route('company.editInternshipSave') }}" aria-label="{{ __('Register') }}" >
                        @csrf
                     ...
                     <div class="form-group row">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('company.workingInternship', ['id' => $post->placement_drive_id ]) }}" class="btn btn-outline-danger">{{__('Go to  Working Internships')}}</a>
                            </div>
                        </div>
                    </form>
                </div>
