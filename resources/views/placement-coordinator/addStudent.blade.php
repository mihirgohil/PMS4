        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                      ...
                      @endif
                    <form method="POST" id="frm"  name="frm" action="{{ route('placement-coordinator.addStudentStore') }}" aria-label="{{ __('Register') }}" onsubmit="return validate()" enctype="multipart/form-data">
                        @csrf
