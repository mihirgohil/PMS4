...
<!-- Main content -->
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row mb-3">
          <div class="col-sm-10">
          <h2 class="m-0 text-dark">All Students of Placement Drive : {{ $placement_drive->drive_name }}</h2>
          </div><!-- /.col -->
          <div class="col-sm-1">
            <a href="{{ route('placement-coordinator.print_student_all_report',['drive_id' => $placement_drive->id ]) }}" class="btn btn-success" target="_blank">print</a>
